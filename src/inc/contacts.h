#pragma once
#include "../../thrd/rang/include/rang.hpp"
...
private:
  ...
  std::pair<std::string, std::string> company =
      std::make_pair("Company", "(none)");
  ...
  std::pair<std::string, std::string> email2 =
      std::make_pair("Email_2", "(none)");
  std::pair<std::string, std::string> phone = std::make_pair("Phone", "(none)");
  std::pair<std::string, std::string> phone2 =
      std::make_pair("Phone_2", "(none)");
  std::pair<std::string, std::string> address =
      std::make_pair("Address", "(none)");
  std::pair<std::string, std::string> website =
      std::make_pair("Website", "(none)");
  std::pair<std::string, std::string> social =
      std::make_pair("Social", "(none)");
